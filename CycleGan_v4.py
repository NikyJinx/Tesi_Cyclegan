...
class ResidualBlock2D_GLU(nn.Module):
    def __init__(self, channels, kernel_size=3):
        super().__init__()
        # ORA IL KERNEL È 2D: kernel_size=3 equivale a (3, 3). 
        # Il padding=1 (ovvero 3//2) mantiene inalterate le dimensioni spaziali (sia frequenza che tempo).
        # In questo modo le frequenze comunicano tra loro!
        self.conv = nn.Conv2d(channels, channels * 2, kernel_size=kernel_size, padding=kernel_size//2)
...
class Generator_2_1_2D(nn.Module):
    def __init__(self, in_channels=3):
        ...
        self.res_blocks = nn.Sequential(
            *[ResidualBlock2D_GLU(64) for _ in range(6)]  # Usa 9 se passi a 256x256
        )
    ...
    with open(log_path, "a", encoding="utf-8") as log_file:
        with contextlib.redirect_stdout(Tee(sys.stdout, log_file)):
            ...
            train_cyclegan(
                ...
                domain_b_dir="E:\\Dataset_Tesi\\dataset_dominio_B",
