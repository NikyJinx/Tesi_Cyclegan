...
# 1,2,4,8 amplia progressivamente il campo recettivo senza aumentare molto i parametri,
# cosi ogni blocco vede contesto tempo/frequenza piu ampio. Il reset finale 1,2
# riporta il focus sui dettagli locali per rifinire texture e armoniche fini.
...
class NpyDataset(Dataset):
    ...
    def __init__(self, folder, expected_shape=(3, 512, 512), validate_files=True):
...
def train_cyclegan(
    ...
    for epoch in range(start_epoch, num_epochs + 1):
        ...
        for batch_idx, (real_A, real_B) in enumerate(zip(loader_A, loader_B), 1):
            ...
            # Update D less frequently, and skip if D is already too strong
            if batch_idx % 2 == 0:
                loss_D.backward()
                opt_D.step()
...
if __name__ == "__main__":
    ...
    with open(log_path, "a", encoding="utf-8") as log_file:
        with contextlib.redirect_stdout(Tee(sys.stdout, log_file)):
            ...
            print("=" * 90)
            train_cyclegan(
                domain_a_dir="E:\\Dataset_Tesi\\dataset_dominio_A",
                domain_b_dir="E:\\Dataset_Tesi\\dataset_dominio_B_8Bit",
